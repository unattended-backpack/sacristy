...
/**
  ...
  This contract inherits from Solady's `Receiver` to handle ERC-721 and ERC-1155
  safe transfer callbacks, allowing delegated EOAs to receive such assets via
  safe transfer methods.

  @custom:date January 6th, 2026.
*/
contract MulticallDelegate is
  Receiver {
